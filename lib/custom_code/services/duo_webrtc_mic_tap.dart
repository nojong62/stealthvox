...
//
// 📡 **만능 통역도 이 통로를 쓴다**(`DUO_INTERP_WEBRTC`가 켜졌을 때).
//   통역은 원음을 상대에게 보내지 않지만(`sendAudio: false`), 마이크는 똑같이
//   WebRTC로 연다 — AEC/NS/AGC를 태운 PCM을 전사에 쓰는 것이 목적이기
//   때문이다. 플래그가 꺼져 있으면 기존 `PreparedAudioCapture` 그대로다.
//
