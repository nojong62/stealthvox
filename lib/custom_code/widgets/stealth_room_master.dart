                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildManualItem('Duo Connect', '초청 직접 대화',
                              '초청 링크로 부른 상대와 서로의 실제 목소리로 자연스럽게 통화하면서, 그 통화에서 어학 공부 자료를 수집하는 기능입니다. 통화가 끝나면 오간 대화가 공부방으로 이어집니다 — 되먹임·중복·말 고르는 소리처럼 공부에 쓸모없는 부분만 걷어낸 Replay(정돈된 대화)로 다시 세워 드립니다.'),
