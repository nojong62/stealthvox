...
class _RoutineModeDuoState extends State<RoutineModeDuo> {
  ...
  void initState() {
    ...
    _countdownTimer = Timer.periodic(const Duration(seconds: 1), (timer) {
      if (!_isTimerPaused && _remainingSecondsNotifier.value > 0) {
...
// ============================================================================
  ...
  Future<void> _handleAutoSaveAndExit() async {
    ...
    if (mounted) context.pushNamed('StealthRoom');
  }
            ...
            IconButton(
                icon: const Text("A-",
                    style: TextStyle(
                        ...
                        fontSize: 16)),
                onPressed: () => setState(() =>
                    _fontScale = (_fontScale > 0.8) ? _fontScale - 0.1 : 0.8)),
            IconButton(
                icon: const Text("A+",
                    style: TextStyle(
                        color: Colors.white,
                        ...
                        fontSize: 18)),
                onPressed: () => setState(() =>
                    _fontScale = (_fontScale < 1.5) ? _fontScale + 0.1 : 1.5)),
          ]),
