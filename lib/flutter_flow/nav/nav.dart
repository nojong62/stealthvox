...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? LobbyWidget() : IntroWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: LobbyWidget.routeName,
          path: LobbyWidget.routePath,
        ...
        FFRoute(
          name: StealthRoomWidget.routeName,
          path: StealthRoomWidget.routePath,
          builder: (context, params) => StealthRoomWidget(
            historyRef: params.getParam(
              'historyRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['users', 'chat_history'],
            ),
            roomId: params.getParam(
              'roomId',
              ParamType.String,
